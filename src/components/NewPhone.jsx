...
const NewPhone = () => {
  return (
    <section class="py-8">
    <div
      class={`container mx-auto bg-[url('assets/phoneImg.png')] overflow-hidden bg-cover bg-no-repeat w-full h-[370px] pt-[61px] lg:pl-[581px] md:pl-[400px] sm:pl-[200px] pl-5 flex flex-col items-start`}
    >
