...
import ProTwoImg from "../assets/pro-two.png"
import ProOneImg from "../assets/pro-one.jpg"
  ...
  return (
    ...
    <Container>
      ...
      <div className="flex justify-between">
        <div className="w-[35%]">
          <img src={ProOneImg} alt="" className="w-full" />
        </div>
        <div className="w-[35%]">
          <img src={ProTwoImg} alt="" className="w-full" />
        </div>
      </div>
